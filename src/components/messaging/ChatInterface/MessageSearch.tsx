...
  // Correctly handle participants as either array of strings or array of objects with email
  const getConversationName = (conversation: { participants: Array<{ email?: string } | string>; }) => {
    if (conversation.participants && conversation.participants.length > 0) {
      const first = conversation.participants[0];
      if (typeof first === 'string') {
        return first || 'Unknown User';
      } else if ('email' in first && typeof first.email === 'string') {
        return first.email || 'Unknown User';
      }
    }
