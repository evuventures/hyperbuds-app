            ...
            <div className="flex flex-col gap-4 justify-center items-center p-6 rounded-xl sm:flex-row sm:justify-center sm:p-6 theme-transition">
               <div className="flex gap-4 items-center">
                  ...
                  <div className="relative flex-shrink-0">
                     <div className="p-2.5 bg-gradient-to-br from-purple-500 to-pink-500 rounded-lg shadow-lg dark:from-purple-600 dark:to-pink-600">
                        <RefreshCw className="w-5 h-5 text-white animate-spin" />
                     </div>
                     <div className="absolute inset-0 bg-gradient-to-br from-purple-400 to-pink-400 rounded-lg opacity-0 blur-md animate-pulse dark:opacity-20"></div>
                  </div>
   ...
   return (
      <section className="space-y-6" data-section="recommendations">
         ...
         <div className="flex flex-col gap-4 justify-center items-center p-6 rounded-xl sm:flex-row sm:justify-center sm:p-6 theme-transition">
            <div className="flex gap-4 items-center">
               {/* Icon */}
               <div className="flex-shrink-0 p-2.5 bg-gradient-to-br from-purple-500 to-pink-500 rounded-lg dark:from-purple-600 dark:to-pink-600">
