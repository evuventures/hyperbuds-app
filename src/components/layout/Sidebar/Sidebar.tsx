...
export const Sidebar: React.FC<SidebarProps> = ({ user, activeTab, collapsed, onTabChange, onToggleCollapse }) => {
  ...
  const mainMenuItems: MenuItem[] = [
    ...
    { id: 'streaming', icon: Video, label: 'Live Streaming', path: '/streaming' }
  ];
  ...
  const commItems: MenuItem[] = [
    ...
    { id: 'invites', icon: Send, label: 'Invites', path: '/invites' },
    { id: 'networking', icon: UserPlus, label: 'Network', path: '/networking' }
  ];
