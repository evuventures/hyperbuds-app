        ...
        <div className="flex flex-col items-center max-w-sm text-center">
          <div className="relative mb-6">
            <div className="bg-slate-50 dark:bg-slate-800 rounded-2xl p-5 shadow-xl dark:shadow-2xl transform transition-transform hover:scale-105 border border-slate-200 dark:border-slate-700">
              ...
              <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 w-4 h-4 bg-slate-50 dark:bg-slate-800 rotate-45 rounded-sm border-r border-b border-slate-200 dark:border-slate-700" />
            </div>
          </div>
          <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-2 tracking-tight">No conversation selected</h3>
            ...
            <React.Fragment key={msg._id}>
              {isNewDay && (
                <div className="flex justify-center my-8">
                  <span className="px-4 py-1.5 rounded-full bg-slate-100 dark:bg-slate-800/40 border border-slate-200 dark:border-slate-700/50 text-[11px] font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-widest">
