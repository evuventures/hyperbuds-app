          ...
          <div className="mx-auto max-w-6xl">
            ...
            <div className="mb-6 text-center">
              <div className="flex justify-center items-center mb-2">
                <div className="p-3 mr-3 rounded-2xl bg-gradient-to-br from-purple-500 to-pink-500">
            ...
            {/* Content */}
            <div className="p-8 rounded-2xl border-2 border-purple-200/50 backdrop-blur-sm shadow-xl bg-white/90 dark:bg-slate-800/90 dark:border-purple-500/30">
              {isLoading ? (
                <div className="flex flex-col items-center justify-center py-16">
                  <Loader2 className="w-16 h-16 mb-4 text-purple-600 animate-spin dark:text-purple-400" />
                ...
                <div className="flex flex-col items-center justify-center py-16">
                  <div className="p-6 mb-4 rounded-xl bg-red-50 dark:bg-red-900/20">
                  ...
                  <Button onClick={() => refetch()} variant="outline" className="border-purple-500 text-purple-600 hover:bg-purple-50">
                    Try Again
                  </Button>
                </div>
              ) : mutualMatches.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-16">
                  <div className="p-6 mb-4 rounded-full bg-gradient-to-br from-purple-100 to-pink-100 dark:from-purple-900/30 dark:to-pink-900/30">
            ...
            {mutualMatches.length > 0 && (
              <div className="grid grid-cols-1 gap-4 mt-6 md:grid-cols-3">
                <div className="p-6 text-center rounded-xl bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 border border-purple-200 dark:border-purple-500/30">
                ...
                <div className="p-6 text-center rounded-xl bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 border border-blue-200 dark:border-blue-500/30">
                ...
                <div className="p-6 text-center rounded-xl bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border border-green-200 dark:border-green-500/30">
