...
export default function EditProfilePage() {
  return (
    <DashboardLayout>
      <div className="relative min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-950 dark:to-purple-900/10">
        ...
        <div className="overflow-hidden fixed inset-0 pointer-events-none">
          ...
          <div className="absolute top-1/2 left-1/2 w-[500px] h-[500px] bg-indigo-200/20 dark:bg-indigo-500/10 rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2" />
        </div>

        <div className="relative z-10 px-4 pt-6 pb-12 md:px-6">
          <Card />
        </div>
      </div>
    </DashboardLayout>
